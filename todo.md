...
- [x] Increase logo size to match mockup proportions
- [x] Adjust logo positioning - move higher and more centered
- [x] Fix "COMING 2026" text color to lighter gray (#b0b0b0)
- [x] Adjust "COMING 2026" positioning - move lower
